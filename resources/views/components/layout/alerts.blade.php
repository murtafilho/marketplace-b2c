...
{{-- Descrição: Sistema de alertas e notificações do layout --}}

<div x-data="{ show: true }" class="space-y-4 mb-4">
    {{-- Flash Messages --}}
    @if (session('success'))
        <div x-show="show" 
    ...
    @if (session('info'))
        <div x-show="show" 
             ...
             x-transition:leave-start="opacity-100 transform scale-100"
             x-transition:leave-end="opacity-0 transform scale-95"
             class="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start space-x-3">
            <div class="flex-shrink-0">
            ...
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                    <h3 class="text-sm font-medium text-red-800 mb-2">
                        {{ __('Por favor, corrija os seguintes erros:') }}
                    </h3>
